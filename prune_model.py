...
train_dataset = datasets.ImageFolder(root='../ucf5_dataset/train', transform=transform)
train_dataloader = DataLoader(train_dataset, batch_size=4, shuffle=True, num_workers=2)

test_dataset = datasets.ImageFolder(root='../ucf5_dataset/test', transform=transform)
test_dataloader = DataLoader(test_dataset, batch_size=4, shuffle=False, num_workers=2)

val_dataset = datasets.ImageFolder(root='../ucf5_dataset/validation', transform=transform)
